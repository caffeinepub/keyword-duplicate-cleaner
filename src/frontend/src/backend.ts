...
export class Backend implements backendInterface {
    ...
    async addEntries(arg0: Array<[string, bigint]>): Promise<Array<bigint>> {
        if (this.processError) {
            try {
                const result = await this.actor.addEntries(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addEntry(arg0: string, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async analyzeDuplicates(): Promise<Array<DuplicateGroup>> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeDuplicates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async cleanDuplicates(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.cleanDuplicates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllEntries(): Promise<Array<KeywordEntry>> {
        if (this.processError) {
            try {
